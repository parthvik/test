...
@InputType()
class EducationCreateNestedManyWithoutEngineersInput {
...
export { EducationCreateNestedManyWithoutEngineersInput as EducationCreateNestedManyWithoutEngineersInput };
